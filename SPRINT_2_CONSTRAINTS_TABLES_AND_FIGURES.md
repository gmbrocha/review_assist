...
- `SPRINT_2_1_SOURCE_PROFILE_AND_BASEMAPS.md`: example report profile, source status behavior, NAIP/MARIS basemap service, and Census source setup.
- `SPRINT_2_2_COMPARISON_CONSTRAINTS_AND_TABLES.md`: comparison-unit constraints, source-specific normalization, and exact deliverable table generation.
