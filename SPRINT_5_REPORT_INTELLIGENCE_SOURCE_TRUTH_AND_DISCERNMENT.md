...
This file and the linked active subunit files are root-level planning notes for human review. Sprint 5.0 through Sprint 5.7 are archived as completed; move each remaining subunit doc into `docs/archive/sprints/` only when that subunit is completed under the normal sprint protocol.
