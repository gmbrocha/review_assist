...
Sprint 5.0 planning resolution, Sprint 5.1 canonical policy schema reconciliation, and Sprint 5.2 extent semantics enforcement are complete. Sprint 5.3 is the active next implementation target.
...
This file and the linked active subunit files are root-level planning notes for human review. Sprint 5.0, Sprint 5.1, and Sprint 5.2 are archived as completed; move each remaining subunit doc into `docs/archive/sprints/` only when that subunit is completed under the normal sprint protocol.
