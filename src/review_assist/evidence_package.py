...
SOURCE_ID_CATEGORY_HINTS = {
    ...
    "maris_npdes_facilities": "regulated_facilities",
    "maris_solid_waste_landfills": "regulated_facilities",
    "maris_superfund_sites": "regulated_facilities",
    "maris_tri_facilities": "regulated_facilities",
    "maris_underground_storage_tanks": "regulated_facilities",
