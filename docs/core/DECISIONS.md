...
| 2026-05-17 | `CANONICAL_PLAN.md` is the active high-level planning source. | Prior planning docs were consolidated; duplicates should defer to the canonical plan unless a later decision supersedes it. | Planning, sprints, docs. | 2026-05-28 archived plan decision. |
| 2026-05-28 | The former root `CANONICAL_PLAN.md` is archived as historical context at `docs/archive/CANONICAL_PLAN.md`. | The implemented baseline now records current direction in `docs/core/CURRENT_STATE.md`, durable decisions, domain docs, and machine-readable contracts such as the deliverable matrix and report policy. | Planning, docs, agent context routing. | |
