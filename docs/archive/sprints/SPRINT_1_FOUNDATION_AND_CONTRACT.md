...
- `docs/archive/sprints/SPRINT_1_3_COMPARISON_UNITS_AND_ORCHESTRATION.md`: implemented Sprint 1.3 historical reference for comparison-unit model, line/point grouping, populate integration, and Sprint 1 documentation/test completion.
