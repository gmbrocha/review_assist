...
- `PLAN_REDIRECT.md`: superseded planning source retained for historical context. Active planning lives in `../../PLAN_REDIRECT_NEW.md`.
- `DELIVERABLE_OUTLINE.md`: superseded deliverable outline retained for historical context. Active deliverable structure lives in `../../PLAN_REDIRECT_NEW.md`.
- `REPORT_GEN_SYSTEM_PROMPT.md`: superseded prompt planning reference retained for historical context. Active prompt rules live in `../../PLAN_REDIRECT_NEW.md`.
