...
- Generated context, source status, source inventory, draft findings, comparison tables, draft maps, review queue, and populate artifacts are ignored by Git.
