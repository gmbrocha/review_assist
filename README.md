...
8. Compile accepted or explicitly included reviewed content into editable Markdown/DOCX export packages, or create a clearly labeled internal preview demo package when showing the draft deliverable shape.
